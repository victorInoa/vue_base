...
onMounted(() => {
  ...
  if (ctx) {
    ...
    chart.value = new Chart(ctx, configVerticalBarChart)
  }
})
      ...
      <div class="flex flex-col w-full 2xl:w-2/3">
        <div class="flex-1 bg-white rounded-lg shadow-xl p-8">
          ...
          <p class="mt-2 text-slate-700">
            ...
            elit. Ut, magni odio magnam commodi sunt ipsum eum! Voluptas eveniet aperiam at maxime,
            iste id dicta autem odio laudantium eligendi commodi distinctio!
          </p>
        </div>
        <div class="flex-1 bg-white rounded-lg shadow-xl mt-4 p-8">
